...
window.FESTIVAL_GAMES = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Completing the board earns 1,200 base points, plus up to 300 speed-bonus points that fade the longer you take (gone after 5 minutes).',
      'Every flip beyond the 16 needed for a perfect game costs 15 points. Fewer moves and a faster time both mean a higher score. Maximum possible score: 1,500.',
    ],
  },
  {
    key: 'proverb',
